...
lenses grounded in principles. The deliverable is a synthesized verdict — do NOT make
changes.
...
Read `docs/agents/principles.md`. Follow every `[[wikilink]]` and read each linked principle file.
