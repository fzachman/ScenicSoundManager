...
| 008 | Soundboard: one-shot SFX panel docked below main window (user-requested feature) | Feature | M–L | — | IN PROGRESS (Phases 1–3 done 2026-07-15 on `feature/soundboard`; dock spike PASS, capacity spike: 64 players fine, no caps; suite 572→622) |
